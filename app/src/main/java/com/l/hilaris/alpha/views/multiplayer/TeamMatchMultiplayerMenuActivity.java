...
public class TeamMatchMultiplayerMenuActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void startGame(boolean multiplayer) {
        ...
        Intent intent = new Intent(this, SinglePlayerSudokuActivity.class);
